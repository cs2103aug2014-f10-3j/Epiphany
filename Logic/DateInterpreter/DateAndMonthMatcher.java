...
class DateAndMonthMatcher implements strtotime.Matcher {

	private final Pattern datewletters = Pattern.compile(".*(\\d\\d|\\d)(st|nd|rd|th).*");
	private final Pattern datewoletters = Pattern.compile(".*(\\d\\d|\\d).*");
