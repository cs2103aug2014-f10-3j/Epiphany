...
class DayMatcherWithTime implements Matcher {
	...
	private final Pattern saturday = Pattern.compile("(this |)saturday \\d+:\\d\\d");
	private final Pattern sunday = Pattern.compile("(this |)sunday \\d+:\\d\\d");
	private final Pattern monday = Pattern.compile("(this |)monday \\d+:\\d\\d");
	private final Pattern tuesday = Pattern.compile("(this |)tuesday \\d+:\\d\\d");
	private final Pattern wednesday = Pattern.compile("(this |)wednesday \\d+:\\d\\d");
	private final Pattern thursday = Pattern.compile("(this |)thursday \\d+:\\d\\d");
	private final Pattern friday = Pattern.compile("(this |)friday \\d+:\\d\\d");
